...
use gixgiz_contracts::{
    ...
    ChatGenerationEventsRequest, ChatGenerationEventsResponse, ChatRuntimeStatus, ClientHello,
    CoreHello, CreateConversationRequest, CreateConversationResponse, DeleteConversationRequest,

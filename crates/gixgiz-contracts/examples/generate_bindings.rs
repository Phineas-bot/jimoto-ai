...
use gixgiz_contracts::{
    BootstrapReady, BootstrapRequest, CancelGenerationRequest, CancelGenerationResponse,
    CancelOperationRequest, CancelOperationResponse, ChatGenerationEvent,
    ChatGenerationEventsRequest, ChatGenerationEventsResponse, ChatRuntimeStatus,
    ChatRuntimeStatusRequest, ChatRuntimeStatusResponse, ClientHello, CoreHello,
    CreateConversationRequest, CreateConversationResponse, DeleteConversationRequest,
    DeleteConversationResponse, GetConversationRequest, GetConversationResponse, HardwareScanEvent,
    HardwareScanStartRequest, HardwareScanStartResponse, HealthRequest, HealthResponse,
    ListConversationsRequest, ListConversationsResponse, RecommendationRequest,
    RecommendationResponse, RenameConversationRequest, RenameConversationResponse,
    RuntimeConsentRequest, RuntimeConsentResponse, RuntimeInstallApprovalRequest,
    RuntimeInstallApprovalResponse, RuntimeInstallEvent, RuntimeInstallPlanRequest,
    ...
    SendMessageRequest, SendMessageResponse, SetupApprovalRequest, SetupApprovalResponse,
    SetupJobCancelRequest, SetupJobCancelResponse, SetupJobEvent, SetupJobEventsRequest,
    SetupJobEventsResponse, SetupJobRecoveryRequest, SetupJobRecoveryResponse,
    SetupJobRetryRequest, SetupJobRetryResponse, SetupJobStartRequest, SetupJobStartResponse,
    SetupJobStatusRequest, SetupJobStatusResponse, SetupPlanRequest, SetupPlanResponse,
...
struct TransportContractDocument {
    ...
    runtime_install_plan_request: RuntimeInstallPlanRequest,
    runtime_install_plan_response: RuntimeInstallPlanResponse,
    runtime_install_approval_request: RuntimeInstallApprovalRequest,
    runtime_install_approval_response: RuntimeInstallApprovalResponse,
    runtime_install_start_request: RuntimeInstallStartRequest,
    runtime_install_start_response: RuntimeInstallStartResponse,
    runtime_install_status_request: RuntimeInstallStatusRequest,
    runtime_install_status_response: RuntimeInstallStatusResponse,
    runtime_install_event: RuntimeInstallEvent,
    runtime_status_request: RuntimeStatusRequest,
    runtime_status_response: RuntimeStatusResponse,
    runtime_consent_request: RuntimeConsentRequest,
    runtime_consent_response: RuntimeConsentResponse,
    runtime_model_inventory_request: RuntimeModelInventoryRequest,
    runtime_model_inventory_response: RuntimeModelInventoryResponse,
    runtime_operation_start_request: RuntimeOperationStartRequest,
    runtime_operation_start_response: RuntimeOperationStartResponse,
    runtime_operation_event: RuntimeOperationEvent,
    setup_plan_request: SetupPlanRequest,
    setup_plan_response: SetupPlanResponse,
    setup_approval_request: SetupApprovalRequest,
    setup_approval_response: SetupApprovalResponse,
    setup_job_start_request: SetupJobStartRequest,
    setup_job_start_response: SetupJobStartResponse,
    setup_job_status_request: SetupJobStatusRequest,
    setup_job_status_response: SetupJobStatusResponse,
    setup_job_recovery_request: SetupJobRecoveryRequest,
    setup_job_recovery_response: SetupJobRecoveryResponse,
    setup_job_cancel_request: SetupJobCancelRequest,
    setup_job_cancel_response: SetupJobCancelResponse,
    setup_job_retry_request: SetupJobRetryRequest,
    setup_job_retry_response: SetupJobRetryResponse,
    setup_job_event: SetupJobEvent,
    setup_job_events_request: SetupJobEventsRequest,
    setup_job_events_response: SetupJobEventsResponse,
    create_conversation_request: CreateConversationRequest,
    create_conversation_response: CreateConversationResponse,
    list_conversations_request: ListConversationsRequest,
    list_conversations_response: ListConversationsResponse,
    get_conversation_request: GetConversationRequest,
    get_conversation_response: GetConversationResponse,
    rename_conversation_request: RenameConversationRequest,
    rename_conversation_response: RenameConversationResponse,
    delete_conversation_request: DeleteConversationRequest,
    delete_conversation_response: DeleteConversationResponse,
    send_message_request: SendMessageRequest,
    send_message_response: SendMessageResponse,
    chat_generation_event: ChatGenerationEvent,
    chat_generation_events_request: ChatGenerationEventsRequest,
    chat_generation_events_response: ChatGenerationEventsResponse,
    chat_runtime_status: ChatRuntimeStatus,
    chat_runtime_status_request: ChatRuntimeStatusRequest,
    chat_runtime_status_response: ChatRuntimeStatusResponse,
